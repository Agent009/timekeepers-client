...
export const constants = Object.freeze({
  ...
  routes: {
    ...
    server: {
      ...
      createLayer: "layer",
      getLayerRecord: "layer/:recordId",
      getLayerRecords: "layer",
      updateLayerRecord: "layer/:recordId",
      deleteLayerRecord: "layer/:recordId",
      createEpoch: "epoch",
      getEpochRecord: "epoch/:recordId",
      getEpochRecords: "epoch",
      updateEpochRecord: "epoch/:recordId",
      deleteEpochRecord: "epoch/:recordId",
